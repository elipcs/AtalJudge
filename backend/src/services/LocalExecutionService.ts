/**
 * @module services/LocalExecutionService
 * @description Service for executing code locally using Docker containers.
 * Replaces Judge0Service with a lightweight implementation.
...
export class LocalExecutionService {
    ...
    private async executeSubmission(
        ...
        sh -c "${runCmd} ${stdinPart}"`;
            ...
            // Check if timeout (exit code 124 for timeout command usually)
            if (error.code === 124 || error.message.includes('timeout')) {
